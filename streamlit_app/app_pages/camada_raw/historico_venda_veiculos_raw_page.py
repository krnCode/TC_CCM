"""
Página de visualização dos dados brutos (camada raw) do historico de venda de veículos..
"""
...
st.set_page_config(
    page_title="Historico de Venda de Veículos",
    layout="wide",
)
...
# region ----- Introdução -----
st.title("Historico de Venda de Veículos")
st.write(
    """
        Nesta página são apresentados os dados brutos do historico de venda de veículos.
